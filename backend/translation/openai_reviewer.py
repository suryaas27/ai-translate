...
class OpenAIReviewer(BaseReviewer):
    ...
    def evaluate_translation(self, original_text: str, translated_text: str, target_language: str) -> Dict:
        """
        Evaluate the quality of a translation using GPT-4o.
        """
...
"""
        ...
        try:
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are a professional translator and linguistic judge."},
            ...
            print(f"OpenAI Reviewer Error: {e}")
            return {
                "score": 0,
                "error": str(e),
